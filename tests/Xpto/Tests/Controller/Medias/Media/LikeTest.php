...
class LikeTest extends WebTestCase
{
    ...
    public function getMediaWithoutAuthHeader()
    {
        ...
        $client->request('GET', '/media/1/like');
    ...
    {
        $client = $this->createClient();
        $client->request('GET', '/media/1/like', [], [], $this->header);
    ...
    {
        $client = $this->createClient();
        $client->request('POST', '/media/1/like');
    ...
    {
        $client = $this->createClient();
        $client->request('POST', '/media/2/like', [], [], $this->header);
    ...
    {
        $client = $this->createClient();
        $client->request('PUT', '/media/1/like');
    ...
    {
        $client = $this->createClient();
        $client->request('PUT', '/media/1/like', [], [], $this->header);
    ...
    {
        $client = $this->createClient();
        $client->request('DELETE', '/media/1/like/1');
    ...
    {
        $client = $this->createClient();
        $client->request('DELETE', '/media/1/like/1', [], [], $this->header);
