 ...
 * @license proprietary
 */
namespace Xpto\Tests\Entity\Medias\Album;

use DateTime;
use Domain\Entity\Medias\Album;
use Domain\Entity\Users\User;
use Xpto\Entity\Medias\Album\Comment;
...
class CommentTest extends PHPUnit_Framework_TestCase
{
    ...
    public function validObjects()
    {
        ...
        $albumMock = Mockery::mock(Album::class);
        $albumMock->shouldReceive('isDeleted')->andReturn(false)->byDefault();
        $albumMock->shouldReceive('getId')->andReturn(1)->byDefault();
    ...
    public function invalidObjects()
    {
        ...
        $albumMock = Mockery::mock(Album::class);
        $albumMock->shouldReceive('isDeleted')->andReturn(true)->byDefault();
        $albumMock->shouldReceive('getId')->andReturn(0)->byDefault();
     ...
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::getId
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::getCreated
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::setCreated
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::getUpdated
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::setUpdated
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::getStatus
     */
     ...
     * @test
     *
     * @covers Xpto\Entity\Albums\Album\Comment::isNewer
     */
     ...
     * @test
     *
     * @covers Xpto\Entity\Albums\Album\Comment::isActive
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::delete
     */
    ...
    public function deleteThrowsExceptionWhenAlreadyDeleted($obj)
    {
        ...
        $this->modifyAttribute($comment, 'status', Album::DELETED);
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::getUser()
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::setUser()
     ...
     * @test
     *
     * @covers Xpto\Entity\Albums\Album\Comment::getAddress()
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::setAddress()
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::getAgent()
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::setAgent()
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::getAlbum()
     */
    public function getAlbumReturnAlbumAttribute($obj)
    {
        $comment = new Comment();

        $this->modifyAttribute($comment, 'album', $obj->album);

        $this->assertSame($obj->album, $comment->getAlbum());
    }
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::setAlbum()
     * @covers       Xpto\Entity\Albums\Album::isDeleted()
     */
    public function setAlbumReturnEmptyWhenAlbumIsValid($obj)
    {
        $comment = new Comment();
        $result = $comment->setAlbum($obj->album);
     ...
     * @expectedException InvalidArgumentException
     */
    public function setAlbumThrowsExceptionWhenAlbumIsDeleted($obj)
    {
        $comment = new Comment();
        $comment->setAlbum($obj->album);
    }
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::getContent()
     */
     ...
     * @dataProvider validObjects
     *
     * @covers       Xpto\Entity\Albums\Album\Comment::setContent()
     */
