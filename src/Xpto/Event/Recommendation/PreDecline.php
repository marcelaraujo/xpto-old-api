 ...
 */
final class PreDecline
{
    /**
     * @var string
     */
    const NAME = 'recommendation.pre-decline';
    ...
    public function dispatch(Event $event)
    {
        ...
        if ($recommendation->getDestination()->getId() !== $this->app['user']->getId()) {
            throw new InvalidArgumentException('You can not decline recommendations from others');
        }
    }
}
